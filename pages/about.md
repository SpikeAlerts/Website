...
When all alerts end for a user, an end of spike alert message is sent to the subscriber, detailing the length and severity of the event, and a unique reporting option through REDCap. This information is also archived for future reference (excluding the user's location/phone number).
